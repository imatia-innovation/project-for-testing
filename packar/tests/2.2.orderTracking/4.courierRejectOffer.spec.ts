...
const order1: OfferTest = {
    title: `Reject Order with courierNOFixedPrice: ${courierNOFixedPrice.providerName} First Offer without Limit Price`,
...
const order2: OfferTest = {
    title: `Reject Order with courierNOFixedPrice: ${courierNOFixedPrice.providerName} First Offer with Limit Price 99.99`,
    pickUpLocation: PICKUP_LOCATION,
    reference: 'atest' + new Date().getTime().toString(),
    provider: courierNOFixedPrice.providerName,
    service: 0,
...
const order3: OfferTest = {
    title: `Reject Order with courierNOFixedPrice: ${courierNOFixedPrice.providerName} Manual Assignment without Limit Price`,
    pickUpLocation: PICKUP_LOCATION,
    reference: 'atest' + new Date().getTime().toString(),
    provider: courierNOFixedPrice.providerName,
    service: 0,
...
const order4: OfferTest = {
    title: `Reject Order with courierNOFixedPrice: ${courierNOFixedPrice.providerName} Manual Assignment with Limit Price 99.99`,
    pickUpLocation: PICKUP_LOCATION,
    reference: 'atest' + new Date().getTime().toString(),
    provider: courierNOFixedPrice.providerName,
    service: 0,
...
const order5: OfferTest = {
    title: `Reject Order with courierFixedPrice: ${courierFixedPrice.providerName} First Offer without Limit Price`,
    pickUpLocation: PICKUP_LOCATION,
    reference: 'atest' + new Date().getTime().toString(),
...
const order6: OfferTest = {
    title: `Reject Order with courierFixedPrice: ${courierFixedPrice.providerName} First Offer with Limit Price 9.99`,
    pickUpLocation: PICKUP_LOCATION,
    reference: 'atest' + new Date().getTime().toString(),
    provider: courierFixedPrice.providerName,
    service: 0,
...
const order7: OfferTest = {
    title: `Reject Order with courierFixedPrice: ${courierFixedPrice.providerName} Manual Assignment without Limit Price`,
    pickUpLocation: PICKUP_LOCATION,
    reference: 'atest' + new Date().getTime().toString(),
    provider: courierFixedPrice.providerName,
    service: 0,
...
const order8: OfferTest = {
    title: `Reject Order with courierFixedPrice: ${courierFixedPrice.providerName} Manual Assignment with Limit Price 9.99`,
    pickUpLocation: PICKUP_LOCATION,
    reference: 'atest' + new Date().getTime().toString(),
    provider: courierFixedPrice.providerName,
    service: 0,
